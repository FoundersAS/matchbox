...
var i = 0;
var base64decode = function base64decode(b64) {
  return new Buffer(b64, 'base64').toString();
};

var gmailFormatter = function gmailFormatter(token) {
  return through.obj(function (email, enc, cb) {
    ...
    if (email.payload.parts[0].parts && email.payload.parts[0].parts.length && email.payload.parts[0].parts[0].body && email.payload.parts[0].parts[0].body.data) {
